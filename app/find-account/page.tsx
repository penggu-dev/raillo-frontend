                  ...
                  {!showVerification ? (
                    <>
                      <div className="text-center mb-6">
                        <p className="text-gray-700">
                          ...
                          회원번호를 찾으실 수 있습니다.
                          <br />
                          이메일 인증을 통해 본인 확인 후 회원번호를 확인할 수
                          있습니다.
                        </p>
                      </div>
                    ...
                    <>
                      ...
                      <div className="text-center mb-6">
                        ...
                        <p className="text-gray-700">
                          <span className="font-medium">{userEmail}</span>로
                          인증 코드를 전송했습니다.
                          <br />
                    ...
                    <>
                      <div className="text-center mb-6">
                        <p className="text-gray-700">
                          ...
                          <br />
                          이메일 인증을 통해 본인 확인 후 새 비밀번호를 설정할
                          수 있습니다.
                        </p>
                      </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setPasswordMemberNumber(e.target.value)
                                }
                                className="pl-10"
                                disabled={isLoading}
                              />
                      ...
                      <div className="bg-gray-50 rounded-lg p-4">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 leading-relaxed">
                              회원번호를 모르시는 경우 먼저 회원번호 찾기를
                              이용해 주세요. 본인 확인 후 등록된 이메일로 인증
                              코드가 전송되며, 인증 완료 시 새 비밀번호를 설정할
                              수 있습니다.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="bg-green-50 rounded-lg p-4">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 leading-relaxed">
                              비밀번호는 8자 이상이어야 하며, 영문, 숫자,
                              특수문자를 포함하는 것을 권장합니다. 비밀번호 변경
                              후 자동으로 로그인 페이지로 이동합니다.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-green-50 rounded-lg p-4 mt-6">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 leading-relaxed">
                              새로운 비밀번호로 로그인하실 수 있습니다. 보안을
                              위해 정기적으로 비밀번호를 변경하시는 것을
                              권장합니다.
                            </p>
                          </div>
                        </div>
