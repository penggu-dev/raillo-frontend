        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground">회원가입</span>
              <span>/</span>
              <span className="text-foreground">본인 인증</span>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="shadow-lg">
            <CardContent className="p-8">
              <div className="mb-8">
                <h1 className="text-2xl font-bold text-foreground mb-4">본인 인증하여 가입</h1>
              ...
              <div className="bg-muted rounded-lg p-6">
                ...
                <div className="space-y-4 text-sm text-muted-foreground">
                  ...
                  <div>
                    <span className="font-medium text-primary">• 회원가입 절차</span> 본인인증 완료 후 기존 회원 여부를
              ...
              <div className="mt-8 pt-6 border-t border-border">
                <div className="flex justify-center space-x-6 text-sm">
                  ...
                  <Link href="/" className="text-primary hover:text-primary-active font-semibold">
                    홈으로
                  </Link>
                </div>
              </div>
